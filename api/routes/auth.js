...
// JWT token generation for Telegram auth
function generateJwtToken(user) {
  ...
  const payload = {
    ...
    id: user._id.toString(), // For compatibility with auth middleware
...
router.post('/telegram', async (req, res) => {
  try {
    ...
    console.log('🔑 Generated JWT token (first 20 chars):', jwtToken.substring(0, 20) + '...');
