export const CATEGORY_KEYWORD_RULES = [
  ...
  // Ягоды
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-berries',
    keywords: [
      'малина', 'клубника', 'черника', 'голубика', 'ежевика', 'смородина',
      'крыжовник', 'земляника', 'брусника', 'клюква', 'вишня', 'черешня',
      'арбуз', 'дыня', 'виноград', 'ягоды', 'свежая ягода', 'садовая ягода',
      'мороженая', 'замороженная', 'лесная ягода'
    ],
    weight: 5
  },
  ...
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-vegetables',
    keywords: [
      'помидоры', 'томаты', 'огурцы', 'картошка', 'картофель', 'морковь',
      'свекла', 'капуста', 'лук', 'чеснок', 'перец', 'баклажан', 'кабачок',
      'тыква', 'редис', 'редька', 'репа', 'сельдерей', 'горох', 'фасоль',
      'кукуруза', 'овощи', 'свежие овощи', 'домашние овощи'
    ],
    weight: 5
  },
  ...
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-fruits',
    keywords: [
      'яблоки', 'груши', 'сливы', 'абрикосы', 'персики', 'нектарины',
      'алыча', 'айва', 'гранат', 'хурма', 'инжир', 'фрукты',
      'свежие фрукты', 'садовые фрукты', 'домашние фрукты'
    ],
    weight: 5
  },
  ...
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-greens',
    keywords: [
      'зелень', 'укроп', 'петрушка', 'кинза', 'базилик', 'мята',
      'салат', 'руккола', 'шпинат', 'щавель', 'лук зелёный', 'лук зеленый',
      'микрозелень', 'пряные травы', 'свежая зелень'
    ],
    weight: 5
  },
  ...
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-dairy',
    keywords: [
      'молоко', 'творог', 'сметана', 'сливки', 'кефир', 'ряженка',
      'йогурт', 'масло', 'сыр', 'брынза', 'домашнее молоко', 'фермерское',
      'козье молоко', 'коровье молоко', 'яйца', 'яйцо', 'куриные яйца',
      'перепелиные', 'домашние яйца', 'деревенские яйца', 'фермерские яйца'
    ],
    weight: 5
  },
  ...
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-honey',
    keywords: [
      'мёд', 'мед', 'пчелиный', 'липовый мёд', 'цветочный мёд',
      'гречишный', 'майский мёд', 'соты', 'прополис', 'перга', 'пыльца'
    ],
    weight: 5
  },
  ...
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-meat',
    keywords: [
      'мясо', 'свинина', 'говядина', 'баранина', 'телятина', 'кролик',
      'курица', 'утка', 'гусь', 'индейка', 'перепел', 'фарш',
      'домашнее мясо', 'фермерское мясо', 'парное мясо'
    ],
    weight: 5
  },
  ...
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-plants',
    keywords: [
      'рассада', 'саженцы', 'семена', 'черенки', 'луковицы', 'клубни',
      'рассада помидор', 'рассада перца', 'рассада клубники', 'саженцы яблони',
      'саженцы малины', 'саженцы смородины', 'растения', 'цветы'
    ],
    weight: 5
  },
  
  // Грибы (добавляем в овощи, т.к. нет отдельной категории)
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-vegetables',
    keywords: [
      'грибы', 'шампиньоны', 'вёшенки', 'вешенки', 'белые грибы',
      'лисички', 'опята', 'маслята', 'подберёзовики', 'сушёные грибы'
    ],
    weight: 4
  },
  ...
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-canning',
    keywords: [
      'варенье', 'джем', 'повидло', 'компот', 'соленья', 'маринады',
      'консервация', 'заготовки', 'лечо', 'аджика', 'квашеная капуста',
      'солёные огурцы', 'маринованные помидоры', 'маринованные грибы', 'солёные грибы'
    ],
    weight: 4
  },
  
  // Картофель (отдельная категория)
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-potato',
    keywords: [
      'картошка', 'картофель', 'бульба', 'молодой картофель'
    ],
    weight: 6
  },
  ...
  {
    categorySlug: 'farmer-market',
    subcategorySlug: 'farmer-feed',
    keywords: [
      'сено', 'солома', 'зерно', 'пшеница', 'овёс', 'ячмень', 'кукуруза зерно',
      'комбикорм', 'корм для животных', 'отруби'
    ],
    weight: 5
  },
