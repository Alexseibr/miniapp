...
Для старых публикаций используйте `./scripts/versionize-legacy.sh <version> [--ref <ref>] [--push] [--no-branch]` — он ставит тег `v<version>` на нужный коммит и при желании создаёт/публикует релизную ветку `release/<major.minor>`.
