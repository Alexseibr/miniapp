...
const sellerNavItems: NavItem[] = [
  { path: '/farmer/cabinet', label: 'Фермерский кабинет', icon: Store, requiresAuth: true },
  { path: '/seller/dashboard', label: 'Кабинет продавца', icon: TrendingUp, requiresAuth: true },
